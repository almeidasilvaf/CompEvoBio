...
No. The published tree shows turtles as a sister group to birds and 
...
1. The first tree has the worst log-likelihood.
2. No, we cannot reject the tree (p = 0.426).
3. No, we cannot reject the tree (p = 0.412).
